...
const LOCATIONS = [
  ...
  {
    name: "Mr Biryani — Gachibowli",
    address: "Gachibowli Square, Hyderabad, Telangana 500032",
    hours: "12 PM – 11 PM Daily",
    ...
    <section ref={sectionRef} id="locations" className={styles.section}>
      ...
      <div className={styles.container}>
        ...
        <div ref={headerRef} className={styles.header}>
          ...
          <h2 className={styles.title}>Visit Our Royal Kitchen</h2>
